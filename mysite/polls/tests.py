...
class QuestionIndexViewTests(TestCase):
    ...
    def test_no_questions(self):
        ...
        """
        response = self.client.get(reverse('pollls:index'))
    ...
    def test_past_question(self):
        """
        Questions with pub_date in the past are displayed in the index page.
        """
    ...
    def test_two_past_question(self):
        ...
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(response.contex['latest_question_list'], ['<Question: Past question one.>',\
                                                                           '<Question: Past question two.>'])
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        The detail view of question with a pub_date in the past displays the question's text.
        """
